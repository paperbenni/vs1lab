        ...
        updateLocation: function() {
            if (document.getElementById("latitude").value == "") {
                tryLocate(function(position) {
                    ...
                    var mapList = JSON.parse(document.getElementById("result-img").dataset.tags)

                    mapurl = getLocationMapSrc(position.coords.latitude, position.coords.longitude, mapList, 14);
                    console.log(mapurl);
